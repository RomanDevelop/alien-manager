#!/usr/bin/env python3
"""
Скрипт для продления пресейла ALIEN Token на 20 дней
"""
...
def extend_presale():
    ...
    try:
        ...
        # Отправляем транзакцию (исправлено для новых версий web3.py)
        try:
            # Попробуем новый способ
            tx_hash = w3.eth.send_raw_transaction(signed_txn.rawTransaction)
        except AttributeError:
            # Если не работает, попробуем старый способ
